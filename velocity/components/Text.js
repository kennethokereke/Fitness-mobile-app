...
export default class Typography extends Component {
  render() {
    ...
    const textStyles = [
      ...
      right && styles.right,
      color && { color },
      color && color === 'pink' && styles.pink,
      color && color === 'lightred' && styles.lightred,
      color && color === 'darkred' && styles.darkred,
...
const styles = StyleSheet.create({
  ...
  lightred: { color: theme.colors.lightred, },
  darkred: { color: theme.colors.darkred, },
